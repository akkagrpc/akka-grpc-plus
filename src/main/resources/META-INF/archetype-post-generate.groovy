...
content = content.replaceAll("com.akkagrpc.proto", "${groupId}" + "." + "${aggregate_name_with_lower_case}")
content = content.replaceAll("com.akkagrpc.grpc", "com.akkagrpc." + "${aggregate_name_with_lower_case}")
content = content.replaceAll("movie", artifactIdLowerCaseExp)
content = content.replaceAll("Movie", artifactIdProperCaseExp)
event_content = event_content.replaceAll("com.akkagrpc.proto", "${groupId}" + "." + "${aggregate_name_with_lower_case}")
event_content = event_content.replaceAll("com.akkagrpc.grpc", "com.akkagrpc." + "${aggregate_name_with_lower_case}")
