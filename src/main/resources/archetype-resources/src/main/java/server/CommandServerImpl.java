...
import com.akkagrpc.${aggregate_name_with_lower_case}.${aggregate_name_with_proper_case}Service;
import com.akkagrpc.${aggregate_name_with_lower_case}.${aggregate_name_with_proper_case}ServicePowerApi;
import com.akkagrpc.${aggregate_name_with_lower_case}.${aggregate_name_with_proper_case}ServicePowerApiHandlerFactory;
    ...
    public class Nodes implements Serializable {
        ...
        String toJson() {
            ...
            try {
                ...
                return String.format("{ ${symbol_escape}"error${symbol_escape}" : ${symbol_escape}"%s${symbol_escape}" }", e.getMessage());
            }
        }
    }
