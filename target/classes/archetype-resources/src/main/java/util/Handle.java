...
import static ${package}.util.ReactiveUtils.appendError;
import static ${package}.util.ReactiveUtils.typeSafe;
...
public final class Handle {
     ...
     * @see Connection${symbol_pound}commitTransaction()
     * @see Connection${symbol_pound}rollbackTransaction()
     */
     ...
     * @return a {@link Flux} of results
     * @throws IllegalArgumentException if {@code resourceFunction} is {@code null}
     * @see Connection${symbol_pound}setTransactionIsolationLevel(IsolationLevel)
     * @see Connection${symbol_pound}commitTransaction()
     * @see Connection${symbol_pound}rollbackTransaction()
     */
    @SuppressWarnings("unchecked")
